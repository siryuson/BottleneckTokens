#!/usr/bin/env python
"""CLI wrapper for UCF101 training Lance conversion."""
...
from vlm2emb.data.conversion.ucf101_train import ensure_ucf101_indices, write_ucf101_root
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--raw-root", type=Path, help="Raw UCF101 root with videos/ and splits/")
    parser.add_argument("--vlm2vec-root", type=Path, help="Local VLM2Vec/UCF101 metadata root")
...
def main() -> int:
    """Run the UCF101 conversion wrapper."""

    args = parse_args()
    if args.ensure_indices_only:
        ensure_ucf101_indices(args.output)
        return 0
