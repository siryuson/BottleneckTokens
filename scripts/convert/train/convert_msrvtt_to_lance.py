#!/usr/bin/env python
"""CLI wrapper for MSR-VTT training Lance conversion."""
...
from vlm2emb.data.conversion.msrvtt_train import ensure_msrvtt_indices, write_msrvtt_root
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--source-root", type=Path, help="Local MSR-VTT root with split JSON files and raw_videos/")
    ...
    parser.add_argument(
        ...
        type=int,
        default=64,
        help="Maximum pre-extracted frames per full video or pre-clipped video",
    )
    parser.add_argument(
        "--max-bytes-per-file",
        type=int,
