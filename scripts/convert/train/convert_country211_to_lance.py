#!/usr/bin/env python
"""CLI wrapper for Country211 training Lance conversion."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--raw-root", type=Path, required=True, help="Local Country211 WebDataset root")
...
def main() -> int:
    """Run the Country211 conversion wrapper."""

    args = parse_args()
    if args.ensure_indices_only:
        ensure_country211_indices(args.output)
        return 0
    summary = write_country211_root(
