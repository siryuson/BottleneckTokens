#!/usr/bin/env python
"""CLI wrapper for SmthSmthV2 training Lance conversion."""
...
from vlm2emb.data.conversion.ssv2_train import ensure_ssv2_indices, write_ssv2_root
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--raw-root", type=Path, help="Raw SmthSmthV2 root with videos/ and annotations/")
    parser.add_argument("--vlm2vec-root", type=Path, help="Local VLM2Vec/SmthSmthV2 metadata root")
...
def main() -> int:
    """Run the SmthSmthV2 conversion wrapper."""

    args = parse_args()
    if args.ensure_indices_only:
        ensure_ssv2_indices(args.output)
        return 0
