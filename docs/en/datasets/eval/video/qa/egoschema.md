...
> Very-long egocentric video QA benchmark for long-horizon understanding and reasoning.
...
| Property | Value |
|------|-----|
| Original name | EgoSchema |
| Paper | EgoSchema: A Diagnostic Benchmark for Very Long-form Video Language Understanding (Mangalam et al., 2023) ([arXiv](https://arxiv.org/abs/2308.09126)) |
...
- `options`: multiple-choice answer list
...
| Property | Value |
|------|-----|
| Directory | `MMEB-V2/video-tasks/EgoSchema/` |
