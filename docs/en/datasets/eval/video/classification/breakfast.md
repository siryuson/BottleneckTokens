...
> Long-duration Breakfast activity recognition dataset focused on complex action sequence modeling.
...
| Property | Value |
|------|-----|
| Original name | Breakfast Actions |
| Paper | The Language of Actions: Recovering the Syntax and Semantics of Goal-Directed Human Activities (Kuehne et al., 2014) ([CVPR](https://openaccess.thecvf.com/content_cvpr_2014/html/Kuehne_The_Language_of_2014_CVPR_paper.html)) |
...
| Property | Value |
|------|-----|
| Directory | `MMEB-V2/video-tasks/Breakfast/` |
