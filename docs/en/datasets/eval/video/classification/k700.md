...
> Large-scale human action recognition video dataset covering 700 action classes.
...
| Property | Value |
|------|-----|
| Original name | Kinetics-700 |
| Paper | A Short Note on the Kinetics-700 Human Action Dataset (Carreira et al., 2019) ([arXiv](https://arxiv.org/abs/1907.06987)) |
...
| Property | Value |
|------|-----|
| Directory | `MMEB-V2/video-tasks/K700/` |
