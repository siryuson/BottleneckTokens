...
> Night-scene image retrieval subset emphasizing low-light and semantic matching capability.
...
| Paper | See original dataset release information |
| Primary Authors | See original dataset release information |
| HuggingFace | [ziyjiang/MMEB_Test_Instruct](https://huggingface.co/datasets/ziyjiang/MMEB_Test_Instruct) (subset `NIGHTS`) |
| License | See original dataset |

### Schema
Query image/text and candidate image set, parsed with I2I/VG.
...
| Property | Value |
|------|-----|
| Directory | `MMEB-V2/image-tasks/NIGHTS/` |
