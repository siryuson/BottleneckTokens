...
> 面向真实拍摄条件偏移的对象识别数据集，强调视角与背景变化鲁棒性。
...
|------|-----|
| 原始名称 | ObjectNet |
| 论文 | ObjectNet: A large-scale bias-controlled dataset for pushing the limits of object recognition models ([arXiv](https://arxiv.org/abs/1909.13000)) |
| 主要作者 | Andrey Barbu, David Mayo, Julian Alverio, William Luo, Christopher Wang, Dan Gutfreund, Joshua Tenenbaum, Boris Katz |
...
| 属性 | 值 |
|------|-----|
| 目录 | `MMEB-V2/image-tasks/ObjectNet/` |
