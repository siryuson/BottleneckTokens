...
| 属性 | 值 |
|------|-----|
| HuggingFace | [vidore/tatdqa_test_beir](https://huggingface.co/datasets/vidore/tatdqa_test_beir) |
| 分割 | `test` |
...
**query.text**: `What was the total assets from AMER in 2018?...`
**query.images**: 0 张图像
...
| 属性 | 值 |
|------|-----|
| 目录 | `MMEB-V2/visdoc-tasks/ViDoRe_tatdqa/` |
...
```json
{
  "queries.lance": {
    "id": "0",
    "text": "Find a document image that matches the given query: What was the total assets from AMER in 2018?\n",
    "images": {
      "count": 0,
      "items": []
    }
...
#### 示例 2
`query_id=1`，`positive_candidate_id=0`

```json
{
  "queries.lance": {
    "id": "1",
    "text": "Find a document image that matches the given query: What was the total assets from APAC in 2019?\n",
    "images": {
      "count": 0,
      "items": []
    }
