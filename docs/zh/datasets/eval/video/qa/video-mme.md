...
|------|-----|
| 原始名称 | Video-MME |
| 论文 | Video-MME: The First-Ever Comprehensive Evaluation Benchmark of Multi-modal LLMs in Video Analysis（Fu et al., 2024）([arXiv](https://arxiv.org/abs/2405.21075)) |
...
| 属性 | 值 |
|------|-----|
| 目录 | `MMEB-V2/video-tasks/Video-MME/` |
