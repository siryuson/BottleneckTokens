...
|------|-----|
| 原始名称 | NExT-QA |
| 论文 | NExT-QA: Next Phase of Question-Answering to Explaining Temporal Actions（Xiao et al., 2021）([arXiv](https://arxiv.org/abs/2105.08276)) |
