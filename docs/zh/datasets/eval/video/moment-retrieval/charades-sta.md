...
> 基于自然语言描述的时序活动定位基准，来源于 Charades 扩展标注。
...
|------|-----|
| 原始名称 | Charades-STA |
| 论文 | TALL: Temporal Activity Localization via Language Query（Gao et al., 2017）([arXiv](https://arxiv.org/abs/1705.02101)) |
| HuggingFace | [siyrus/BToks-Charades-STA](https://huggingface.co/datasets/siyrus/BToks-Charades-STA) |
| 许可证 | 参见原始数据集 |

### Schema
- `query`: 查询语句
- `clips_dir_path`: 候选片段目录
- `label_name`: 正样本时刻标注
...
| 属性 | 值 |
|------|-----|
| 目录 | `MMEB-V2/video-tasks/Charades-STA/` |
